...
const CARDPOOL = [
  ...
  {id:'c02', art:2, kind:5, col:'#5FD6A8', nm:'翡翠の鶴',   role:'ジェイド',   rar:'A',
   line:'高みから、すべてを見ている。',
   st:{toll:70,mini:56,special:58,fortune:52,build:60,gauge:54,buyout:46},
   sk:{nm:'翠玉の恵み', ds:'自分の街をひとつ、ただで一段育てる', uses:2}},
  ...
  {id:'c05', art:5, kind:10, col:'#F6E6EE', nm:'真珠の兎',   role:'パール',     rar:'S',
   line:'跳べば、どこへでも。',
   st:{toll:60,mini:88,special:62,fortune:76,build:54,gauge:90,buyout:50},
   sk:{nm:'月光の贈り物', ds:'宝箱をひらく。金額は運しだい（最大2.6倍）', uses:3}},
  {id:'c06', art:3, kind:9, col:'#F04A5A', nm:'紅玉の竜',   role:'ルビー',     rar:'S',
   line:'すべては、我が意のままに。',
   st:{toll:86,mini:64,special:48,fortune:46,build:66,gauge:84,buyout:70},
   sk:{nm:'竜の威圧', ds:'一番資産のある相手を監獄へ送る', uses:2}},
  ...
  {id:'c08', art:7, kind:4, col:'#E8A032', nm:'琥珀の熊',   role:'アンバー',   rar:'SS',
   line:'蓄えた分だけ、強い。',
   st:{toll:72,mini:64,special:96,fortune:88,build:92,gauge:60,buyout:98},
   sk:{nm:'琥珀の徴収', ds:'相手全員から所持金の19%を奪う', uses:2}},

  {id:'c09', art:0, kind:6, col:'#BFE4F2', nm:'白銀の狐',   role:'シルバー',   rar:'A',
   line:'知らせは、風より早く届く。',
   st:{toll:48,mini:62,special:66,fortune:72,build:52,gauge:60,buyout:50},
   sk:{nm:'霜結びの便り', ds:'その場で給料を受け取り、次の給料も2倍になる', uses:2}},
  {id:'c10', art:3, kind:7, col:'#C0392B', nm:'深紅の竜',   role:'スカーレット', rar:'S',
   line:'二つの目は、いつも揃う。',
   st:{toll:80,mini:58,special:50,fortune:44,build:64,gauge:88,buyout:62},
   sk:{nm:'双竜の吐息', ds:'次のサイコロが必ずゾロ目になる（もう一度振れる）', uses:3}},
  {id:'c11', art:1, kind:8, col:'#E0B94A', nm:'琥珀の獅子', role:'アンバーレオ', rar:'S',
   line:'この土地の値は、我が決める。',
   st:{toll:92,mini:54,special:56,fortune:50,build:74,gauge:62,buyout:66},
   sk:{nm:'黄金の地脈', ds:'自分の街ぜんぶの通行料が2ターン1.6倍になる', uses:2}}
];
